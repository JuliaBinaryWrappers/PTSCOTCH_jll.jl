# Autogenerated wrapper script for PTSCOTCH_jll for aarch64-unknown-freebsd-mpi+mpitrampoline
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, Zlib_jll, Bzip2_jll, XZ_jll, SCOTCH_jll, MPItrampoline_jll, MPIPreferences)
