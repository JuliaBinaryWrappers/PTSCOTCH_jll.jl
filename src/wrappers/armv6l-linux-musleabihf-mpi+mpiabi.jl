# Autogenerated wrapper script for PTSCOTCH_jll for armv6l-linux-musleabihf-mpi+mpiabi
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, Zlib_jll, Bzip2_jll, XZ_jll, SCOTCH_jll, MPIABI_jll, MPIPreferences)
