# Autogenerated wrapper script for PTSCOTCH_jll for armv7l-linux-musleabihf-mpi+mpich
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, Zlib_jll, Bzip2_jll, XZ_jll, SCOTCH_jll, MPICH_jll, MPIPreferences)
